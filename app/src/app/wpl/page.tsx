...
import { Calendar, Clock, Shield, RefreshCw, TrendingUp } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    for (const tier of lotteryData.tiers) {
      ...
      if (remaining > 0 && remaining <= 30 && !preExpirySyncedRef.current.has(key)) {
        ...
        console.log(`[WPL] Pre-expiry sync: tier $${tier.tier} expires in ${remaining}s`);
