...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 *                       DRAW DPL WINNER SCRIPT
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Triggers draw_dpl_winner for a specific DPL tier (requires time expiry).
 * Anyone can call — no admin wallet required. Treasury pays all draw costs.
 *
 * Usage: ANCHOR_WALLET=/path/to/wallet.json npx ts-node scripts/draw-dpl-winner.ts [tier]
 * Example: ANCHOR_WALLET=/home/dev/my-wallet.json npx ts-node scripts/draw-dpl-winner.ts 5
 */
