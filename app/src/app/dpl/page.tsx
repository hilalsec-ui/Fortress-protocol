...
import { Sun, Clock, Shield, Sparkles, RefreshCw } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    for (const tier of lotteryData.tiers) {
      ...
      if (remaining > 0 && remaining <= 30 && !preExpirySyncedRef.current.has(key)) {
        ...
        console.log(`[DPL] Pre-expiry sync: tier $${tier.tier} expires in ${remaining}s`);
