  ...
  "instructions": [
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "docs": [
            "Buyer's FPT ATA — must already exist (buyer needs FPT to buy tickets)"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "treasuryVault",
          "docs": [
            "Treasury vault PDA — pays ATA rent so the claimer pays zero SOL"
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "lotteryState",
          "docs": [
            "Vault PDA validated in body via stored bump (seed differs by lottery type)"
          ],
          "writable": true
        },
        {
        ...
        {
          "name": "pythEntropyAccount"
        },
        {
          "name": "winnerHistory",
          "docs": [
            "WinnerHistory PDA validated in body via stored bump"
          ],
          "writable": true
        },
        {
      ...
      "accounts": [
        {
          "name": "authority",
          "docs": [
            "Permissionless caller — receives caller reward"
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "pendingDraw",
          "docs": [
            "PendingDraw PDA — consumed + closed here"
          ],
          "writable": true
        },
        {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "lotteryState",
          "docs": [
            "Vault PDA — read-only; validated in instruction body via stored bump"
          ]
        },
        {
          "name": "pendingDraw",
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "sequenceNumber",
            "docs": [
              "Reserved for future Pyth Entropy V2 sequence_number"
            ],
            "type": "u64"
          },
          {
            "name": "userCommitment",
            "docs": [
              "User-supplied randomness commitment (XOR'd with Pyth entropy at fulfill)"
            ],
            "type": {
              "array": [
                "u8",
          ...
          },
          {
            "name": "requester",
            "docs": [
              "Wallet that called request_draw (receives caller reward at fulfill)"
            ],
            "type": "pubkey"
          },
          {
