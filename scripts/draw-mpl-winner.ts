...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 *                       DRAW MPL WINNER SCRIPT
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Triggers draw_mpl_winner for a specific MPL tier (requires time expiry).
 * Anyone can call — no admin wallet required. Treasury pays all draw costs.
 *
 * Usage: ANCHOR_WALLET=/path/to/wallet.json npx ts-node scripts/draw-mpl-winner.ts [tier]
 * Example: ANCHOR_WALLET=/home/dev/my-wallet.json npx ts-node scripts/draw-mpl-winner.ts 5
 */
